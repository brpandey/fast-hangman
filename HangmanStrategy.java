...
public class HangmanStrategy implements GuessingStrategy
{
	/*
		...
		e.g. if processing ASTERISK and the correct guess is the 
		letter 't' and it is the correct hangman word and the current 
		formation is -S----S-, we would simulate it is as -ST---S- .
	...
	*/									
							...
							Map<Character, Integer> map, boolean simulate) 
	{
		...
		try
		{
			...
			{
				throw new IllegalArgumentException("input parameter(s) can't be null");
			}
