...
/* Class not written by Bibek Pandey */
...
class HangmanGame {
  ...
  /**
   * The word that needs to be guessed (e.g. 'ASTERISK')
   */
  ...
  /**
   * Set of all correct letter guesses so far (e.g. 'S', 'E', 'R', 'T', 'K')
   */
  private Set<Character> correctlyGuessedLetters = new HashSet<Character>();

  /**
   * Set of all incorrect letter guesses so far (e.g. 'O', 'L')
   */
  private Set<Character> incorrectlyGuessedLetters = new HashSet<Character>();

  /**
   * Set of all incorrect word guesses so far (e.g. 'ARTERIAL')
   */
